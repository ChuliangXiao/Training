...
cp -r ~wrfhelp/PRE_COMPILED_CHEYENNE/WRFV3.7.1_intel_dmpar_large-file/test/em_real/* WRFV3/
```
## WPS: `namelist.wps` 
`cd WPS` 
...
* Replace the example with my Lake Champlain `namelist.wrf`  
    + `cp ~cxiao/WORK/Champlain/WRF/namelist.wrf .`  
...
├── GWBUCKPARM_LC_20180220.nc
├── GWBUCKPARM_LC_20180412.nc
├── GWBUCKPARM.TBL
├── HYDRO.TBL
├── HYDRO_TBL_2D.nc
├── LAKEPARM_2018_04_12.nc
├── LAKEPARM_2018_04_25.nc
├── MPTABLE.TBL
├── RouteLink_LakeChamplain2018_02_20.nc
...
## Generate Forcing  
NCL with Earth System Modeling Framework (ESMF) 
```
ESMF_regrid
```
...
* Fine routing component `namelist.hrldas` 
